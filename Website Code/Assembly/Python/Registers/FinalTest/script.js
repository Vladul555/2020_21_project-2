const quizData = [{
        question: "Which statement about Assembly registers is correct?",
        a: "Processor Registers consist of six 16-bit processor registers",
        b: "general registers are further divided into Data registers, Pointer registers, and Index registers",
    ...
    {
        question: "Which statement isn't correct about registers?",
        a: "There are ten 32-bit and six 16-bit processor registers",
        b: "Data registers are used for arithmetic, logical, and other operations",
        c: "Index Registers are used for indexed addressing and sometimes used in addition and subtraction",
        d: "Pointer Registers could be used in multiplication operation,",
        correct: "d",
    },
    {
        question: "what does Operators byte ptr and word ptr do?",
        a: "Assign address of Index Register without using the value of Data register",
        b: "Assign address of Index Register using the value of Data register",
        c: "Assign value to address of Data register without using Index Register",
        d: "Assign value to address of Data register using Index Register",
        correct: "c",
    },
    {
        question: "Which flag register indicates the result of an arithmetic operation?",
        a: "Zero Flag",
        b: "Overflow Flag",
        c: "Trap Flag ",
        d: "Carry Flag",
    ...
    {
        question: "Which of those is a proper syntax that is needed to input the value 600 in Index Register",
        a: "MOV BX,600H",
        b: "MOV [BP],600H",
        c: "MOV DI 600H",
        d: "none of the above",
    ...
    {
        question: "Which Arithmetic Instructions is used for addition to value in Data register using a single operand",
        a: "DEC Instruction",
        b: "INC Instruction",
        c: "ADD Instruction",
        d: "SUB Instruction",
